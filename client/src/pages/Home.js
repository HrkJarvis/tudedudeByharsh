        ...
        <div className="hero-content">
          ...
          {!isAuthenticated && (
            <div className="hero-cta">
              <Link to="https://tutedude-production.up.railway.app/register" className="btn btn-primary">
                Get Started
              </Link>
              <Link to="https://tutedude-production.up.railway.app/login" className="btn btn-outline">
                Sign In
              </Link>
            </div>
          )}
