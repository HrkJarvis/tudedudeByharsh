...
const useVideoProgress = (videoId, videoDuration) => {
  ...
  }, [videoId, getVideoProgress, isAuthenticated]);
  ...
  const calculateUniqueWatchedTime = useCallback((intervals) => {
  ...
  const calculateProgressPercentage = useCallback((intervals, duration) => {
